...
Comparing reactions from 2 of the [Family Four](https://conwaylife.com/wiki/Familiar_fours):
...
Comparing the [Unique Father Problem](https://conwaylife.com/wiki/Unique_father_problem) and Pattern Balance Technique:
<br/>
